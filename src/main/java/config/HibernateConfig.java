...
public class HibernateConfig {
    ...
    private static void getAnnotationConfiguration(Configuration configuration) {
       ...
       configuration.addAnnotatedClass(NBA_Team.class);
       configuration.addAnnotatedClass(NBA_Division.class);
       configuration.addAnnotatedClass(NBA_Arena.class);
       configuration.addAnnotatedClass(NBA_Location.class);
       configuration.addAnnotatedClass(NBA_Player.class);
       configuration.addAnnotatedClass(NBA_Conference.class);
